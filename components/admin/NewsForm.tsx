...
const formSchema = z.object({
    ...
    published_at: z.string().optional(), // Using string for date input
});
...
export function NewsForm({ initialData }: NewsFormProps) {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: initialData ? {
            ...
            // Format date for input type="datetime-local" if exists
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            const payload = {
                ...
                // Ensure correct date format or null
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 bg-neutral-900/40 p-6 rounded-lg border border-neutral-800">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-neutral-400">Publish Date</FormLabel>
                                        <FormControl>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-neutral-400">Excerpt (Short description)</FormLabel>
                                <FormControl>
